...
class Config:
    ...
    TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6323122698:AAEHv6A61oB6fVt2TChJJOiKr-nx55zW12Y")
    ...
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/SC_PBot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/SC_PBot"
    )
    #
